...
const allFieldTypes = ['string', 'number', 'integer', 'object', 'array', 'boolean', 'null', 'oneOf', '$ref'];
const rootSchemaTypes = ['object', 'array', 'oneOf', 'string', 'number', 'integer', 'boolean', 'null'];

export const FIELD_TYPES = {
    all: allFieldTypes,
    root: rootSchemaTypes,
};
